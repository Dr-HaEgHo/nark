...
const Card: FC<CardProps> = ({ image, title, route }) => {
  return (
    <div className="w-full h-full rounded-[20px] overflow-hidden relative z-0">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between side-gradient z-10 p-10">
    ...
    <div className="w-full lg:max-h-[696px] mb-[88px] lg:mb-[158px]">
      <div className="container">
        <div className="w-full">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 grid-rows-2 max-md:px-4 max-lg:px-5 gap-6">
