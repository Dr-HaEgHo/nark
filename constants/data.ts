import nike from "@/assets/icons/nikelogo.svg";
import adidas from "@/assets/icons/adidas.svg";
import emptyPic from "@/assets/icons/empty.svg";
import {
  accessories,
  beachguy,
  blackbelt,
...
export const logos = [
  ...
  { id: 2, image: adidas, name: "nike" },
  { id: 3, image: nike, name: "nike" },
  { id: 4, image: adidas, name: "nike" },
  { id: 5, image: nike, name: "nike" },
  { id: 6, image: adidas, name: "nike" },
  { id: 7, image: nike, name: "nike" },
  { id: 8, image: adidas, name: "nike" },
];
...
export const newArrival = [
  {
    ...
    name: "Nike Air Max 2",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe error quae blanditiis hic atque fuga obcaecati necessitatibus fugiat harum reiciendis!",
    images: [whitenike],
    isLiked: false,
    price: 960,
  },
...
export const cosmeticTopDeals = [
  ...
  {
    id: "edfv2cvdfx",
    name: "Night Walker Perfume",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe error quae blanditiis hic atque fuga obcaecati necessitatibus fugiat harum reiciendis!",
    images: [nightwalkerperfume],
    isLiked: false,
    price: 960,
  },
  {
...
const Clothings = [
  ...
  {
    id: "edfv2cadvdfx",
    name: "Casual Corporate Outfit",
    description:
    "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe error quae blanditiis hic atque fuga obcaecati necessitatibus fugiat harum reiciendis!",
    images: [blueshirthatguy],
    isLiked: false,
    price: 960,
  },
  {
    ...
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe error quae blanditiis hic atque fuga obcaecati necessitatibus fugiat harum reiciendis!",
    images: [whiteandblazerguy],
    isLiked: false,
    price: 960,
  },
  {
    id: "edfv5e412f",
    name: "Brown Jacket and Boots",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe error quae blanditiis hic atque fuga obcaecati necessitatibus fugiat harum reiciendis!",
    images: [brownjacketguy],
    isLiked: false,
    price: 960,
  },
  {
...
const Watches = [
  ...
  {
    id: "edfvs3tsgv",
    name: "Silver and Gold Rolex",
    description:
      "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe error quae blanditiis hic atque fuga obcaecati necessitatibus fugiat harum reiciendis!",
    images: [goldsilverwatch],
    isLiked: false,
    price: 960,
  }, 
  {
